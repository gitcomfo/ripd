...
<div class="column6">
    <div class="main_text_box">
        ...
        <div class="domtab">
            <ul class="domtabs">
                <li class="current"><a href="#01">ট্রান্সফার ইন ওউন পাওয়ার স্টোর</a></li>
                <li class="current"><a href="#02">ট্রান্সফার ইন আদার্স পাওয়ার স্টোর</a></li>
                <li class="current"><a href="#03">ট্রান্সফার ইন রিপড</a></li> 
                <li class="current"><a href="#04">ট্রান্সফার ইন অ্যাকাউন্ট</a></li>
            </ul>
        </div>   
        ...
        <div>
            ...
            <form method="POST" onsubmit="">	
                <table  class="formstyle">          
                    <tr><th colspan="2" style="text-align: center;">ট্রান্সফার ইন ওউন পাওয়ার স্টোর</th></tr>
                    <tr>
                        <td>টোটাল এমাউন্ট</td>
        ...
        <div>
            ...
            <form method="POST" onsubmit="">	
                <table  class="formstyle">          
                    <tr><th colspan="2" style="text-align: center;">ট্রান্সফার ইন আদার্স পাওয়ার স্টোর</th></tr>
                    <tr>
                        <td>টোটাল এমাউন্ট</td>
                        <td>:    <input  class="box" type="text" id="total_amount" name="total_amount" /></td>            
                    </tr>
                        ...
                        <td colspan="6">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>১০৩৪০০০</td>
                                    <td>২৩৯০০</td>  
                                    <td><input type="text" name ="need_amount" id="need_amount" readonly></td>
