    ...
    <body>
        <div id="main_container">
            ...
            <div id="header">
                ...
                <div class="banner_adds">রিপড ইউনিভার্সাল</div>
                <div class="banner_sub_adds">রিলীভ এন্ড ইমপ্রুভমেন্ট প্ল্যান অব ডেপ্রাইভড</div>
                ...
                <div class="menu">
                    ...
                    <ul>
                        ...
                        <li><a href="login.php">সাইন ইন/রেজিস্টার</a> </li>
                    </ul>
                </div>
            </div>
