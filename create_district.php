...
<div class="columnSld" style=" padding-left: 50px;">
    <div class="main_text_box">
        <div style="padding-left: 110px;"><a href="index.php?apps=AREA"><b>ফিরে যান</b></a></div>
        <div>           
            <form method="POST" onsubmit="">	
                <table class="formstyle"  style=" width: 98%; ">          
                    <tr><th style="text-align: center" colspan="2"><h1>জেলা তৈরির ফর্ম</h1></th></tr>
                    ...
                    <tr>
                        <td>জেলা নাম</td>
                        <td>:    <input  class ="textfield" type="text" id="district_name" name="district_name" /></td>
                    </tr>
                    <tr>                    
