...
<div class="columnSld" style=" padding-left: 50px;">
    <div class="main_text_box">      
        ...
        <div>           
            <form method="POST" enctype="multipart/form-data" action="" id="sales_form" name="sales_form">	
                <table class="formstyle"  style=" width: 96%; "> 
                    ...
                    <tr>
                        <td>সেলস স্টোরের টাইপ</td>
                        <td>:    
                            <select class="box2" name="sales_type" id="sales_type">
                                <option value="all">-সিলেক্ট করুন-</option> 
                                <option value="Thana">থানা এডমিন</option>
                                <option value="District">জেলা এডমিন</option>
                                <option value="Division">বিভাগীয় এডমিন</option> 
                                <option value="Sub_Power">সাব-পাওয়ার এডমিন</option> 
                                <option value="Power">পাওয়ার এডমিন</option> 
                            </select></td>
                    </tr>
